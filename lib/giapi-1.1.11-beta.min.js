...
var GIAPI={demo:{dabEndpoint:"http://api.eurogeoss-broker.eu/dab/"},logger:{enabled:!1,cnsl:!1,info:{print:function(){return JSON.stringify(this,null,4)}},warn:{print:function(){return JSON.stringify(this,null,4)}},error:{print:function(){return JSON.stringify(this,null,4)}},log:function(t,e){if(GIAPI.logger.enabled)switch(e||(e="info"),GIAPI.logger.cnsl===!0&&console.log(GIAPI.isoDateTime()+" -> "+t),e){case"info":GIAPI.logger.info[GIAPI.isoDateTime()]=t;break;case"warn":GIAPI.logger.warn[GIAPI.isoDateTime()]=t;break;case"error":GIAPI.logger.error[GIAPI.isoDateTime()]=t;break;default:return}}},random:function(){return Math.random().toString(36).slice(2)},query:function(t,e,r,i,n,a,s){var o=r?r.start||1:1,u=r?r.pageSize||10:10,c=e?e.where||"":"";c&&(c=c.west+","+c.south+","+c.east+","+c.north);var m=e?e.when||"":"",l=m?m.from:"",h=m?m.to:"";l&&(l=-1===l.indexOf("T")?l+"T00:00:00Z":l),h&&(h=-1===h.indexOf("T")?h+"T00:00:00Z":h);var p=e?e.what||"":"",f=r&&r.searchOperator?" "+r.searchOperator+" ":" OR ",d="";if(Array.prototype.isArray(p)){for(var y=0;y<p.length;y++)d+=p[y]+f;d=d.substring(0,d.length-4)}else d=p;var g=r?r.searchFields||"":"",v="";if(d&&g)if(Array.prototype.isArray(g)){for(var y=0;y<g.length;y++)v+=g[y]+",";v=v.substring(0,v.length-4)}else v=g;var T=e?e.who||"":"",A=t.endsWith("/")?"":"/";s||(s=GIAPI.random());var I=n?n:"",b="",M="";if(r&&r.extension)if(M="string"==typeof r.extension.relation?r.extension.relation:r.extension.relation.value,r.extension.concepts){d="";var S=r.extension.concepts;if("string"==typeof S)b=S;else{for(var y=0;y<S.length;y++){var D=S[y],w=D.uri();b+=w+","}b=b.substring(0,b.length-1)}}else d=r.extension.keyword;var P=null;P=r&&r.aggregate?"opensearch?reqID="+s+"&aggregate=true&":b||M?"opensearchsemanticenhanced?reqID="+s+"&semExec=expand&":"opensearch?reqID="+s+"&";var x=t+A+"services/"+P;return x+="si="+o+"&",x+="ct="+u+"&",x+="st="+d+"&",x+="searchfields="+v+"&",x+="bbox="+c+"&",x+="ts="+l+"&",x+="te="+h+"&",x+="targetId="+I+"&",a&&(x+="sources="+a+"&"),(i||T)&&(x+="parents="+(i?i:T)+"&"),x+="subj="+encodeURIComponent(b)+"&rela="+M+"&outputFormat=application/json",GIAPI.logger.log("query: "+x),x},status:function(t,e,r){var i=t.endsWith("/")?"":"/",n=e?"&semantic=true":"",a=GIAPI.lbStatusProxyEndpoint?GIAPI.lbStatusProxyEndpoint:t+i+"services/status?";return a+"id="+r+"&format=application/json"+n},concept:function(t,e,r,i,n){var a=t.endsWith("/")?"":"/",s=GIAPI.random(),o="";if(!e)if(e="",i){for(var u=[],c=0;c<i.length;c++){var m=i[c];"string"==typeof m?u.push(m):u.push(m.value)}o=u}else{var l="";for(name in GIAPI.Relation)"NONE"!==name&&"decode"!==name&&(l+=GIAPI.Relation[name].value+",");o=l.substring(0,l.length-1)}var h=n&&n.start?n.start:1,p=n&&n.count?n.count:10,f=n&&n.topLevel?n.topLevel:"false";r=encodeURIComponent(r);var d=t+a+"services/opensearchsemanticenhanced?semExec=suggestion&si="+h+"&ct="+p+"&reqID="+s+"&st="+e+"&topLevel="+f+"&subj="+r+"&rela="+o+"&outputFormat=application/json";return GIAPI.logger.log("concept: "+d),d},access:function(t,e,r,i,n){var a=e.url;a=a.substring(0,a.indexOf("?")),a=a.replace("transformer","http-get");var s="gi-axe-capabilities"===i?"&jsondataoutput=true":"";a+="?service=WPS&request=Execute&identifier="+i+s+"&DataInputs=descriptor=";var o=t;o=o.endsWith("/")?o:o+"/",o+="services/cswiso?request=GetRecordById&version=2.0.2&service=CSW&ElementSetName=full&outputSchema=http://www.isotc211.org/2005/gmi&id=",o+=n,o=encodeURIComponent(o);var u="";if(r){if(o+=";",r.crs&&(u+="outputCRS="+r.crs+";"),r.vectorFormat&&(u+="outputVectorFormat="+r.vectorFormat+";"),r.rasterFormat&&(u+="outputRasterFormat="+r.rasterFormat+";"),r.spatialSubset){var c=r.spatialSubset;u+="outputSubset="+c.west+","+c.south+","+c.east+","+c.north+";"}if(r.temporalSubset){var m=r.temporalSubset;u+="outputTemporalBegin="+m.from+";outputTemporalEnd="+m.to+";"}if(r.resolution){var l=r.resolution;u+="outputResolution="+l.latResolution+","+l.lonResolution}u=encodeURIComponent(u),u+="&RawDataOutput=resource"}var h=a+o+u;return GIAPI.logger.log("access: "+h),h},emptyResultSet:function(t){var e={};return e.size=0,e.pageSize=0,e.start=0,e.pageIndex=0,e.pageCount=0,t&&(e.error=t),e},clone:function(t){return jQuery.extend(!0,{},t)},isoDateTime:function(){return(new Date).format("isoDateTimeMls")}};"function"!=typeof Array.prototype.isArray&&(Array.prototype.isArray=function(t){return"[object Array]"===Object.prototype.toString.apply(t)}),"function"!=typeof Array.prototype.remove&&(Array.prototype.remove=function(t,e){for(var r in t)if(t[r]===e){t.splice(r,1);break}}),"function"!=typeof Array.prototype.distinctValues&&(Array.prototype.distinctValues=function(t){return function(){return this.filter(t)}}(function(t,e,r){return r.indexOf(t,e+1)<0})),"function"!=typeof String.prototype.endsWith&&(String.prototype.endsWith=function(t){return-1!==this.indexOf(t,this.length-t.length)}),function($){$.timer=function(func,time,autostart){return this.set=function(func,time,autostart){if(this.init=!0,"object"==typeof func){var paramList=["autostart","time"];for(var arg in paramList)void 0!=func[paramList[arg]]&&eval(paramList[arg]+" = func[paramList[arg]]");func=func.action}return"function"==typeof func&&(this.action=func),isNaN(time)||(this.intervalTime=time),autostart&&!this.isActive&&(this.isActive=!0,this.setTimer()),this},this.once=function(t){var e=this;return isNaN(t)&&(t=0),window.setTimeout(function(){e.action()},t),this},this.play=function(t){return this.isActive||(t?this.setTimer():this.setTimer(this.remaining),this.isActive=!0),this},this.pause=function(){return this.isActive&&(this.isActive=!1,this.remaining-=new Date-this.last,this.clearTimer()),this},this.stop=function(){return this.isActive=!1,this.remaining=this.intervalTime,this.clearTimer(),this},this.toggle=function(t){return this.isActive?this.pause():t?this.play(!0):this.play(),this},this.reset=function(){return this.isActive=!1,this.play(!0),this},this.clearTimer=function(){window.clearTimeout(this.timeoutObject)},this.setTimer=function(t){var e=this;"function"==typeof this.action&&(isNaN(t)&&(t=this.intervalTime),this.remaining=t,this.last=new Date,this.clearTimer(),this.timeoutObject=window.setTimeout(function(){e.go()},t))},this.go=function(){this.isActive&&(this.action(),this.setTimer())},this.init?new $.timer(func,time,autostart):(this.set(func,time,autostart),this)}}(jQuery),dateFormat=function(){var t=/d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZ]|"[^"]*"|'[^']*'/g,e=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,r=/[^-+\dA-Z]/g,i=function(t,e){for(t=String(t),e=e||2;t.length<e;)t="0"+t;return t};return function(n,a,s){var o=dateFormat;if(1!=arguments.length||"[object String]"!=Object.prototype.toString.call(n)||/\d/.test(n)||(a=n,n=void 0),n=n?new Date(n):new Date,isNaN(n))throw SyntaxError("invalid date");a=String(o.masks[a]||a||o.masks["default"]),"UTC:"==a.slice(0,4)&&(a=a.slice(4),s=!0);var u=s?"getUTC":"get",c=n[u+"Date"](),m=n[u+"Day"](),l=n[u+"Month"](),h=n[u+"FullYear"](),p=n[u+"Hours"](),f=n[u+"Minutes"](),d=n[u+"Seconds"](),y=n[u+"Milliseconds"](),g=s?0:n.getTimezoneOffset(),v={d:c,dd:i(c),ddd:o.i18n.dayNames[m],dddd:o.i18n.dayNames[m+7],m:l+1,mm:i(l+1),mmm:o.i18n.monthNames[l],mmmm:o.i18n.monthNames[l+12],yy:String(h).slice(2),yyyy:h,h:p%12||12,hh:i(p%12||12),H:p,HH:i(p),M:f,MM:i(f),s:d,ss:i(d),l:i(y,3),L:i(y>99?Math.round(y/10):y),t:12>p?"a":"p",tt:12>p?"am":"pm",T:12>p?"A":"P",TT:12>p?"AM":"PM",Z:s?"UTC":(String(n).match(e)||[""]).pop().replace(r,""),o:(g>0?"-":"+")+i(100*Math.floor(Math.abs(g)/60)+Math.abs(g)%60,4),S:["th","st","nd","rd"][c%10>3?0:(c%100-c%10!=10)*c%10]};return a.replace(t,function(t){return t in v?v[t]:t.slice(1,t.length-1)})}}(),dateFormat.masks={"default":"ddd mmm dd yyyy HH:MM:ss",shortDate:"m/d/yy",mediumDate:"mmm d, yyyy",longDate:"mmmm d, yyyy",fullDate:"dddd, mmmm d, yyyy",shortTime:"h:MM TT",mediumTime:"h:MM:ss TT",longTime:"h:MM:ss TT Z",isoDate:"yyyy-mm-dd",isoTime:"HH:MM:ss",isoDateTime:"yyyy-mm-dd'T'HH:MM:ss",isoDateTimeMls:"yyyy-mm-dd'T'HH:MM:ss.l",isoUtcDateTime:"UTC:yyyy-mm-dd'T'HH:MM:ss'Z'"},dateFormat.i18n={dayNames:["Sun","Mon","Tue","Wed","Thu","Fri","Sat","Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],monthNames:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec","January","February","March","April","May","June","July","August","September","October","November","December"]},"function"!=typeof Date.prototype.format&&(Date.prototype.format=function(t,e){return dateFormat(this,t,e)});
GIAPI.GINode=function(){var e,r,a=48,o=96,t=144,n=288,s=576,i=GIAPI.random(),l={},c=arguments[0],p=arguments[1];c?(c.topic&&(c.topic=c.topic.distinctValues()),c.geossCategory&&(c.geossCategory=c.geossCategory.distinctValues()),c.keyword&&(c.keyword=c.keyword.distinctValues())):c={id:""+i,type:"simple",title:"Simple node "+i},l._parent=null,l._id=c.id,l._title=c.title,l.expand=function(a,o){if("simple"===c.type)a.apply(l,[GIAPI.Page([])],GIAPI.emptyResultSet());else{var t=1;4===arguments.length?t=arguments[3]:e=null;var n={};n.start=t,n.pageSize=o;var s=GIAPI.query(g(),null,n,c.id,null);r=a,jQuery.ajax({type:"GET",url:s,crossDomain:!0,dataType:"jsonp",success:function(r){if(e=r.resultSet,e.error)return GIAPI.logger.log("expand error: "+e.error,"error"),a.apply(p,[GIAPI.Page(),e]),void 0;for(var o=[],t=0;t<r.reports.length;t++){var n,s=r.reports[t];n=s.service&&s.service.dabSource===!0?GIAPI.DABSource(s,l):GIAPI.GINode(s,p),n._parent=l,o.push(n)}a.apply(l,[GIAPI.Page(o),e])},complete:function(e,r){GIAPI.logger.log("expand complete status: "+r)},error:function(e,r,o){r+=o.message?", exception -> "+o.message:"",GIAPI.logger.log("expand error: "+r,"error"),a.apply(l,[GIAPI.Page([]),GIAPI.emptyResultSet("Error occurred: "+r)])}})}},l.expandNext=function(a,o){if("simple"===c.type)return!1;if(!e)throw"node not expanded";var t=e.size,n=e.start,s=e.pageSize;if(n+s>t)return!1;if(o){l.expand(r,null,s,n+s)}return!0},l.accessOptions=function(e){{var r=u();arguments[1]}if(r){var a=GIAPI.access(g(),r,null,"gi-axe-capabilities",c.id);try{jQuery.ajax({type:"GET",url:a,crossDomain:!0,dataType:"jsonp",success:function(r){if(r.error)return GIAPI.logger.log("accessoptions error: "+r.error,"error"),e.apply(l,[null,"Unable to retrieve access options: "+r.error]),void 0;r.defaultOptions.resolution,r.defaultOptions.spatialSubset;e.apply(l,[r])},complete:function(e,r){GIAPI.logger.log("accessoptions complete status: "+r)},error:function(r,a,o){a+=o.message?", exception -> "+o.message:"",GIAPI.logger.log("accessoptions error: "+a,"error"),e.apply(l,[null,"Unable to retrieve access options: "+a])}})}catch(o){console.log(o)}return!0}return!1},l.accessLink=function(e,r){var a=u();if(a){if(r){var o=GIAPI.access(g(),a,r,"gi-axe-transform",c.id);e.apply(l,[o])}else{var t=function(r,o){if(o)return GIAPI.logger.log("accessOptions in accessLink error: "+o,"error"),e.apply(l,[null,o]),void 0;var t=r.defaultOptions,n=GIAPI.access(g(),a,t,"gi-axe-transform",c.id);e.apply(l,[n])};l.accessOptions(t)}return!0}return!1},l.preview=function(e,r,i){if(!document.getElementById(e))throw"Canvas element not found";var p=u();if(p){var d=function(a,o){if(o)return GIAPI.logger.log("accessOptions in preview error: "+o,"error"),r.apply(l,["error",o]),void 0;var t=a.defaultOptions;t.rasterFormat="png";var n=GIAPI.access(g(),p,t,"gi-axe-transform",c.id),s=new Image;s.onload=function(){var a=document.getElementById(e);a.width=s.width,a.height=s.height;var o=a.getContext("2d");o.drawImage(s,0,0),r.apply(l,["success"])},s.onerror=function(){GIAPI.logger.log("image loading error"),r.apply(l,["error","Unable to load image, error occurred"])},s.onabort=function(){GIAPI.logger.log("image loading aborted"),r.apply(l,["error","Image loading aborted"])};try{s.src=n}catch(i){return GIAPI.logger.log("unable to load image: "+i.message,"error"),r.apply(l,["error","Unable to load image: "+i.message]),!0}};switch(i){case"extra small":i=a;break;case"small":i=o;break;case"large":i=n;break;case"extra large":i=s;break;case"medium":default:i=t}return l.accessOptions(d,i),!0}return!1},l.overview=function(e,r,i,p){var u=c.overview;if(!u)return!1;if(0>r||r>u.length-1)throw Error("index out of bounds, must be >= 0 and <= "+(u.length-1));if(0===!jQuery("#"+e).length)throw Error("div not found");switch(p){case"extra small":p=a;break;case"small":p=o;break;case"large":p=n;break;case"extra large":p=s;break;case"original":p=null;break;case"medium":default:p=t}var g=u[r],d=new Image;p&&(d.width=p,d.height=p),d.onload=function(){jQuery("#"+e).attr("width",p+"px"),jQuery("#"+e).attr("height",p+"px"),jQuery("#"+e).css("width",p+"px"),jQuery("#"+e).css("height",p+"px"),jQuery("#"+e).append(d),i.apply(l,["success"])},d.onerror=function(){GIAPI.logger.log("image loading error"),i.apply(l,["error","Unable to load image, error occurred"])},d.onabort=function(){GIAPI.logger.log("image loading aborted"),i.apply(l,["error","Image loading aborted"])};try{d.src=g}catch(I){GIAPI.logger.log("unable to load image: "+I.message,"error"),i.apply(l,["error","Unable to load image: "+I.message])}return!0},l.olWMS_Layer=function(e){var r=c.online,a=[];if(r)for(var o=0;o<r.length;o++){var t=r[o],n=t.name,s=t.url,i=t.protocol;if(i&&-1!=i.indexOf("urn:ogc:serviceType:WebMapService:")){var l={layers:n,transparent:"TRUE"};if(e&&e.params)for(key in e.params)l[key]=e.params[key];e&&e.options?a.push(new OpenLayers.Layer.WMS(n,s,l,e.options)):a.push(new OpenLayers.Layer.WMS(n,s,l))}}return a},l.isAccessible=function(){return null!=u()},l.report=function(e){return e&&(c=e),c};var u=function(){if(c.online)for(var e=0;e<c.online.length;e++){var r=c.online[e];if("GI-AXE"===r.protocol)return r}return null},g=function(){return"string"==typeof p?p:p.endpoint()};return l};
